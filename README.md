# xView_detect — Satellite Object Detection with Faster R-CNN (Baseline + Streamlit Demo)
...
- Available in Releases: [Download release weights](https://github.com/<OWNER>/<REPO>/releases/download/v1.0-baseline/ResNet50_best_model.pth)
...
- **Method 2 (Recommended for cloud/deployment):** Download weights from [GitHub Releases](https://github.com/<OWNER>/<REPO>/releases/download/v1.0-baseline/ResNet50_best_model.pth):
